...
export class OnboardingMenuItemDto {
  ...
  @ApiPropertyOptional({
    example:
      'https://res.cloudinary.com/demo/image/upload/v1/bitedrop/vendors/onboarding/birria.jpg',
    description:
...
export class CompleteVendorOnboardingDto {
  ...
  @ApiPropertyOptional({
    example:
      'https://res.cloudinary.com/demo/image/upload/v1/bitedrop/vendors/onboarding/logo.jpg',
    description:
      'Cloudinary image URL returned by POST /api/v1/vendors/me/onboarding/upload',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example:
      'https://res.cloudinary.com/demo/image/upload/v1/bitedrop/vendors/onboarding/truck.jpg',
    description:
      'Cloudinary image URL returned by POST /api/v1/vendors/me/onboarding/upload',
  })
  @IsOptional()
