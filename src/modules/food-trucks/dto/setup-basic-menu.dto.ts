...
export class BasicMenuItemDto {
  ...
  @ApiPropertyOptional({
    example: 'Slow-cooked braised beef tacos served with consommé for dipping',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiPropertyOptional({
    example: 'https://cdn.bitedrop.com/menu/birria-tacos.jpg',
  })
  @IsOptional()
  @IsUrl()
  imageUrl?: string;
...
export class SetupBasicMenuDto {
  ...
  @ApiPropertyOptional({
    example: 'Standard daily menu featuring tacos, burritos, and drinks',
  })
  @IsOptional()
  @IsString()
  description?: string;
